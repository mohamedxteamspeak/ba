...
if (!text) throw `*[❗𝐈𝐍𝐅𝐎❗] INGRESE EL @tag DE ALGUN PARTICIPANTE DEL GRUPO O EL NOMBRE DE LA PERSONA*`
if (command == 'gay2') {
conn.reply(m.chat, `
...
if (command == 'puto') {
conn.reply(m.chat, `
_*${text.toUpperCase()}* *ES* *${(500).getRandom()}%* *${command.replace('how', '').toUpperCase()},* *MAS INFORMACION A SU PRIVADO 🔥🥵 XD*_
`.trim(), m, m.mentionedJid ? {
mentions: m.mentionedJid
} : {})}     
if (command == 'puta') {
