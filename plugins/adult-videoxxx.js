...
if (!db.data.chats[m.chat].modohorny && m.isGroup) throw '*[❗𝐈𝐍𝐅𝐎❗] ◥ ツتم تعطيل أوامر +18 في هذه المجموعة ، إذا كنت مسؤولاً وترغب في تنشيطها ، فاستخدم الأمرツ ◤ #enable modohorny*'   
